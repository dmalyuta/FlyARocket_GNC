...
subplot(2,3,1);
hold on;
plot(time_imu_glob(start_idx:end_idx),r2d(psi_save(start_idx:end_idx)),'Color','red');
plot(time_imu_glob(start_idx:end_idx),r2d(psi_filt(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
leg=legend('Raw yaw $\psi$ [deg]','Filtered yaw $\psi_f$ [deg]'); set(leg,'Interpreter', 'latex');

subplot(2,3,2);
hold on;
plot(time_imu_glob(start_idx:end_idx),r2d(theta_save(start_idx:end_idx)),'Color','red');
plot(time_imu_glob(start_idx:end_idx),r2d(theta_filt(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
leg=legend('Raw pitch $\theta$ [deg]','Filtered pitch $\theta_f$ [deg]'); set(leg,'Interpreter', 'latex');

subplot(2,3,3);
hold on;
plot(time_imu_glob(start_idx:end_idx),r2d(phi_save(start_idx:end_idx)),'Color','red');
plot(time_imu_glob(start_idx:end_idx),r2d(phi_filt(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
leg=legend('Raw roll $\phi$ [deg]','Filtered roll $\phi_f$ [deg]'); set(leg,'Interpreter', 'latex');

subplot(2,3,4);
hold on;
plot(time_imu_glob(start_idx:end_idx),r2d(psi_dot(start_idx:end_idx)),'Color','red');
plot(time_imu_glob(start_idx:end_idx),r2d(psi_dot_filt(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
leg=legend('Raw yaw rate $\dot\psi$ [deg/s]','Filtered yaw rate $\dot\psi_f$ [deg/s]'); set(leg,'Interpreter', 'latex');

subplot(2,3,5);
hold on;
plot(time_imu_glob(start_idx:end_idx),r2d(theta_dot(start_idx:end_idx)),'Color','red');
plot(time_imu_glob(start_idx:end_idx),r2d(theta_dot_filt(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
leg=legend('Raw pitch rate $\dot\theta$ [deg/s]','Filtered pitch rate $\dot\theta_f$ [deg/s]'); set(leg,'Interpreter', 'latex');

subplot(2,3,6);
hold on;
plot(time_imu_glob(start_idx:end_idx),r2d(phi_dot(start_idx:end_idx)),'Color','red');
plot(time_imu_glob(start_idx:end_idx),r2d(phi_dot_filt(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
...
subplot(3,1,1);
plot(time_imu_glob(start_idx:end_idx),r2d(wx(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
leg=legend('X-body rate $\omega_x$ [deg/s]'); set(leg,'Interpreter', 'latex');

subplot(3,1,2);
plot(time_imu_glob(start_idx:end_idx),r2d(wy(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
leg=legend('Y-body rate $\omega_y$ [deg/s]'); set(leg,'Interpreter', 'latex');

subplot(3,1,3);
plot(time_imu_glob(start_idx:end_idx),r2d(wz(start_idx:end_idx)),'Color','black');
xlabel('Time [s]');
...
subplot(3,1,1);
plot(time_imu_glob(start_idx:end_idx),accelX_save(start_idx:end_idx),'Color','black');
xlabel('Time [s]');
leg=legend('X acceleration $a_X$ [m/s$^2$]'); set(leg,'Interpreter', 'latex');

subplot(3,1,2);
plot(time_imu_glob(start_idx:end_idx),accelY_save(start_idx:end_idx),'Color','black');
xlabel('Time [s]');
leg=legend('Y-acceleration $a_Y$ [m/s$^2$]'); set(leg,'Interpreter', 'latex');

subplot(3,1,3);
plot(time_imu_glob(start_idx:end_idx),accelZ_save(start_idx:end_idx),'Color','black');
xlabel('Time [s]');
